...
- 크게 서비스 & 시스템 운영
  - 서비스 운영
    - iOS 심볼 추출 및 업로드 작업 (앱 크래시 획득을 위함), [https://github.com/jx2lee/extract-ios-symbols](https://github.com/jx2lee/extract-ios-symbols)
    - API 서버 IP ACL 관리
  - 시스템 운영
...
- 타 부서와 협업하여 문의 해결 진행
- 그 중 RDS for MySQL 서비스를 중점으로 문의 응대를 진행
...
- [https://github.com/jx2lee/sfo-alert-test](https://github.com/jx2lee/sfo-alert-test)
